...
**Eburon Edge** is a mobile-first application that runs powerful open-source AI models directly on your **Android or iOS device** — with zero censorship, zero cloud dependency, and zero monthly fees.
...
[![Eburon Edge Demo](https://img.youtube.com/vi/2Pnv68iHIaQ/maxresdefault.jpg)](https://youtu.be/2Pnv68iHIaQ)
...
**Eburon Edge** includes a built-in **OpenAI-compatible REST API** so you can connect it to any external tool, script, or IDE extension.

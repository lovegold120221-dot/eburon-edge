...
import 'tts_library_screen.dart';
...
enum _Filter { all, downloaded, uncensored, custom, tts }
      ...
      children: [
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              _chip(context, 'All Models', _Filter.all),
        ...
        // ── Body ─────────────────────────────────────
        Expanded(
          child: _filter == _Filter.tts
              ? const TtsLibraryScreen(embedded: true)
              : Obx(() {
                  ...
                  return ListView(
                    ...
                    children: [
                      ...
                      if (_filter == _Filter.all ||
                        ...
                        ...downloaded
                            .where(
                              (f) => !allCatalog.any((m) => m.filename == f),
                            )
                      ...
                      ...List.generate(filtered.length, (index) {
                        ...
                        final dlState = manager.getDownloadState(
                          model.filename,
                        );
                          ...
                          children: [
                            ModelCard(
                              ...
                              isLoaded:
                                  ...
                                  ctrl.isModelLoaded,
                              isLoadingModel:
                                  ctrl.loadingModelFilename.value ==
                                  model.filename,
                              ...
                              onDelete: () =>
                                  _confirmDelete(context, ctrl, model),
                              onRemoveCustom: () =>
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(
                  color: context.textD.withValues(alpha: 0.5),
                ),
                filled: true,

...
Future<void> main() async {
  ...
  runZonedGuarded(
    () async {
      ...
      runApp(EburonEdgeApp(themeController: themeController));
    },
    (error, stack) {
...
class EburonEdgeApp extends StatelessWidget {
  final ThemeController themeController;

  const EburonEdgeApp({super.key, required this.themeController});
